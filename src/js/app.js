...
function nombreCita(){
    ...
    nombreInput.addEventListener('input', e => {
        const nombreTexto = e.target.value.trim(); // Evita los espacios en blanco
        // Validacion de qie nombreTexto debe tener algo
...
function fechaCita(){
    ...
    fechaInput.addEventListener('input', e => {
        const dia = new Date(e.target.value).getUTCDay(); // Trae el numero del dia( 0 = Domingo , 1 = Lunes.....)
        console.log(e);
        if([0, 6].includes(dia)){ // Si es dia domingo o sabado
            e.preventDefault();
            fechaInput.value = '';
